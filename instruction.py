...
st.markdown(
    ...
    div.stButton > button {
        ...
        font-size: 4vw !important; /* Scaled text size relative to screen width */
    }
...
st.info(
    ...
    * **Controls:** 1. Toggle between **Reveal Mode ⛏️** and **Flag Mode 🚩** using the sidebar menu.
      2. In **Reveal Mode**, click a cell to dig it up.
      3. In **Flag Mode**, click a cell to mark it with a flag if you suspect a mine is hidden there.
    """
)

# Sidebar UI (Collapses nicely on mobile devices)
with st.sidebar:
    st.header("Controls")
