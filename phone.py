...
# 1. We force the block container to fit nicely.
# 2. We force Streamlit columns ([data-testid="stHorizontalBlock"]) to stay horizontal and NEVER stack.
st.markdown(
    """
    <style>
...
if st.session_state.won:
    st.success("🎉 You cleared the minefield!")
