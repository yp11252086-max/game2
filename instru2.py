...
st.markdown(
    ...
    div.stButton > button {
        ...
        font-size: 5vw !important; /* Slightly larger text for clear numbers on mobile */
    }
...
# --- COLLAPSIBLE INSTRUCTIONS (Saves phone space!) ---
...
# --- ON-SCREEN CONTROLS (Accessible directly on mobile) ---
...
with ctrl_col1:
    play_mode = st.radio(
        ...
        horizontal=True,
        label_visibility="collapsed" # Hides text tag to save even more vertical room
    )
